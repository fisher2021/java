 ...
 * <p>ClassName: Code</p>
 * <p>Description: 验证码<p>
 * <p>date 2015年11月20日 下午12:45:53<p>
 * @author zhenghui
 */
...
//	        String path ="/usr/share/markSixImg/"+ fileName;
...
//			ImageIO.write(bi, "jpeg",file);
    ...
    public static boolean validate(HttpServletRequest request){
        Object code=request.getParameter(CHECKCODE);
        Object sessionCode=request.getSession().getAttribute(CHECKCODE);
        if(sessionCode.toString().equalsIgnoreCase(code.toString())){
            return true;
        }else {
            throw new BusinessException(RestErrorCode.PARAM,"验证码错误！");
        }
    }

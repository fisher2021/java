package com.upd.common.util.timer;

import com.upd.common.util.splider.DoSplider;
...
public class test_timer {
    ...
    */
    @Autowired
    private DoSplider doSplider;
    //@Scheduled(fixedDelay = 5000)   //5秒更新一次
//   @Scheduled(cron = "0 0/1 * * * ?")
   @Scheduled(cron = " 0 01 10 * * ?")  //每天10点执行更新
   public void doUpdateIndexData(){
       System.out.println("============doSplider==========");
       doSplider.doSplider();
   }

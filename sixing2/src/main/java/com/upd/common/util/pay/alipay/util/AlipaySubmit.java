package com.upd.common.util.pay.alipay.util;

import com.upd.common.util.pay.alipay.config.AlipayConfig;
import com.upd.common.util.pay.alipay.sign.MD5;
import com.upd.common.util.pay.alipay.util.httpClient.HttpProtocolHandler;
import com.upd.common.util.pay.alipay.util.httpClient.HttpRequest;
import com.upd.common.util.pay.alipay.util.httpClient.HttpResponse;
import com.upd.common.util.pay.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
    	String prestr = AlipayCore.createLinkString(sPara,true); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
        String mysign = "";

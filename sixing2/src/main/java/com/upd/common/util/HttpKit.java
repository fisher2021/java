...
public class HttpKit {
    ...
    public static String post(String method,String url, Map<String, String> queryParas, String data, Map<String, String> headers) {
        HttpURLConnection conn = null;
    ...
    public static String post(String url, Map<String, String> queryParas, String data) {
        return post(POST,url, queryParas, data, (Map)null);
    }

    public static String post(String url, String data, Map<String, String> headers) {
        return post(POST,url, (Map)null, data, headers);
    }

    public static String post(String url, String data) {
        return post(POST,url, (Map)null, data, (Map)null);
    }

    public static String put(String url, Map<String, String> queryParas, String data) {
        return post(PUT,url, queryParas, data, (Map)null);
    }

    public static String put(String url, String data, Map<String, String> headers) {
        return post(PUT,url, (Map)null, data, headers);
    }

    public static String put(String url, String data) {
        return post(PUT,url, (Map)null, data, (Map)null);
    }


    public static String delete(String url, Map<String, String> queryParas, String data) {
        return post(DELETE,url, queryParas, data, (Map)null);
    }

    public static String delete(String url, String data, Map<String, String> headers) {
        return post(DELETE,url, (Map)null, data, headers);
    }

    public static String delete(String url, String data) {
        return post(DELETE,url, (Map)null, data, (Map)null);
    }

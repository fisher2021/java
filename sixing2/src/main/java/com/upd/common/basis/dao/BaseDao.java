package com.upd.common.basis.dao;
...
public interface BaseDao<T, ID extends Serializable> {
   ...
   //保存或修改
     ...
     * @return
     */
    Pagination findbypage(Pagination page, String hql, Object... values);
     ...
     * @return
     */
    int updateByHql(final String hql, final Object ...values);
    ...
    int excuteBySql(String sql,Object... values);

    Pagination findbyPageSQL( final Pagination page,final String sql,final  Object... values);
    List<T> findbySQL(final String sql,final  Object... values);

    Class<?> getEntityClass();

    Object findObject(final String hql, final Object... values);

    String transHqlToSql(String hql,Object[] param );

    int findIntBySQL(String sql,final Object ...values);
